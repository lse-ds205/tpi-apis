...
Current tests:
- Country data endpoint (/v1/country-pillars/{country_code}/{year})
...
def test_get_valid_country_data(client, df_assessments):
    """Test GET endpoint /v1/country-pillars/{country}/{year}.
    ...
    for country, year in zip(valid_requests["Country"], valid_requests["Year"]):
        response = client.get(f"/v1/country-pillars/{country}/{year}")
        msg = (
...
def test_get_country_data_not_assessed(client, df_assessments):
    """Test GET endpoint /v1/country-pillars/{country}/{year} for a country that has not been assessed.
    ...
    for country in not_assessed:
        response = client.get(f"/v1/country-pillars/{country}/2024")
        msg = (
...
def test_get_a_json(client, df_assessments):
    """Test GET endpoint /v1/country-pillars/{country}/{year} for valid country-year combinations.
            ...
            for area in pillar["areas"]:
                ...
                if area['name'] != 'CF.4':
                    ...
                    for indicator in area["indicators"]:
                        ...
                        expected_indicator_keys = ["name", "assessment", "metric"]
